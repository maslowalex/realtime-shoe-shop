defmodule Sneakers23Web.ProductChannelTest do
  ...
  alias Sneakers23.Inventory.{CompleteProduct, Server}

  describe "notify_product_released/1" do
    test "the size selector for the product is broadcasted" do
  ...
  describe "notify_item_stock_change/1" do
    ...
    test "the same stock level doesnt broadcast an event", %{item: item} do
    ...
    test "the different stock level broadcasts an event", %{item: item, product: product} do
